...
const Footer = () => {
  return (
    <footer className="bg_dark_prime bg_image mt_1 overflow" id="join">
        <h4 data-aos="flip-left" className="fs_3xl text_white fw-medium text-center pt-5 ff_poppins">JOIN US</h4>
        <div className="d-flex justify-content-center align-items-center">
            <div className="container ff_poppins ">
                <div className="row align-items-center justify-content-between py-5">
                    <div className="col-lg-8">
                        <a href="#" className="fs_2xl text_white fw-medium pb-3">logo</a>
                        <p className="gray_light fw-normal fs_sm py-3 mw_385 f_phara ">Aenean arcu sed rhoncus sapien
                            euismod cursus morbi lacus, blandit. Placerat tortor duis fames cras pellentesque dui
                            adipiscing neque gravida. Sociis neque consectetur id quis pharetra.
                        </p>
                        <a href="#" className="fs_sm text_white">Email@gmail.com</a>
                    </div>
                    <div className="col-lg-4 pt-5 pt-lg-0">
                        <div className="row ">
                            <div className="col-5">
                                <ul>
                                    <li className="text_white fs_sm fw-medium pb-1 ">Resources</li>
                                    <li>
                            ...
                            <div className="col-5">
                                <p className=" text_white fs_sm fw-medium">Community</p>
                                <div className="d-flex align-items-center gap-2 pt-3">
                                    <a href="https://www.instagram.com/radialcode/" target='blank'><svg className="svg_scale" width="18"
                                    ...
                                    <a href="https://twitter.com/RadialCode/status/1491705531911737344" target='blank'><svg
                                            className="svg_scale" width="20" height="16" viewBox="0 0 20 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="https://discord.com/channels/984345847628181504/999268522427437086" target='blank'><svg
                                            className="svg_scale" width="18" height="14" viewBox="0 0 18 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
